...
def test_generate_piecewise_normal_data_valid_means(
    ...
    n_segments = 2
    X, params = generate_piecewise_normal_data(
        means=means,
        n_samples=10,
        n_variables=2,
...
def test_generate_piecewise_normal_data_valid_n_samples(n_samples: int):
    ...
    X = generate_piecewise_normal_data(n_samples=n_samples, n_segments=1, seed=43)
...
def test_generate_piecewise_normal_data_valid_n_variables(n_variables: int):
    ...
    X = generate_piecewise_normal_data(n_samples=10, n_variables=n_variables)
    assert X.shape[1] == n_variables
