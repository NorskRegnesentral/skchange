...
def make_single_change_X(
    ...
    n_features : int or None, default=None
        Number of features. If None, inferred from estimator tags:
        at least 2 for conditional scorers, otherwise 1.
    ...
    if n_features is None:
        n_features = (
            2 if (interval_scorer_tags and interval_scorer_tags.conditional) else 1
        )
